...
import { Container, Content, Text, Icon, List, ListItem, Left, Body, Right, Thumbnail } from 'native-base';
        ...
        <Image source={require('../../../images/glow2.png')} style={styles.container} >
         ...
         <List>
            <ListItem style={styles.contact} avatar>
              <Left>
                <Thumbnail source={require('../../../images/mapIcon/Icons_0002_Side_24Hours_Icon.png')} />
              </Left>
              <Body>
                <Text style={styles.contactText}>METRO POLICE - 012 358 7095</Text>
              </Body>
              <Right>
                <Thumbnail source={require('../../../images/NewsIcons/75_phone.png')} />
              </Right>
            </ListItem>
            <ListItem style={styles.contact} avatar>
              <Left>
