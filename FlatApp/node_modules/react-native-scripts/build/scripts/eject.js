...
var eject = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
    var filesWithExpo, usingExpo, expoSdkWarning, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, filename, questions, _ref2, ejectMethod, npmOrYarn, appJson, pkgJson, newName, newDisplayName, expName, _ref3, enteredName, enteredDisplayname, ejectCommand, ejectArgs, _spawn$sync, status, projectBabelPath, projectBabelRc, templateBabelPath, templateBabelRc, lolThatsSomeComplexCode;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 70:
            console.log(_chalk2.default.green('Wrote to app.json, please update it manually in the future.'));
            ...
            if (status !== 0) {
              console.log(_chalk2.default.red('Eject failed with exit code ' + status + ', see above output for any issues.'));
              console.log(_chalk2.default.yellow('You may want to delete the `ios` and/or `android` directories.'));
              process.exit(1);
            } else {
          ...
          case 87:
            console.log(_chalk2.default.green('The template .babelrc is no longer necessary after ejecting.\nIt has been successfully deleted.'));
            _context.next = 91;
            break;

          case 90:
            console.log(_chalk2.default.yellow('It looks like you modified your .babelrc file.\nMake sure to change your babel preset to `react-native`.'));
          ...
          case 93:
            ...
            console.log(_chalk2.default.yellow('We had an issue preparing your .babelrc for ejection.\nIf you have a .babelrc in your project, make sure to change the preset to `react-native`.'));
            console.log(_chalk2.default.red(_context.t6));
          ...
          case 107:
            ...
            console.log(_chalk2.default.green('Your package.json is up to date!'));
          ...
          case 114:
            ...
            console.log(_chalk2.default.green('Added new entry points!'));
    ...
    }, _callee, this, [[0, 129], [11, 15, 19, 27], [20,, 22, 26], [75, 93]]);
  }));
